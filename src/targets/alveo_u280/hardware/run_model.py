...
def file_names(Planter_config):
    ...
    model_test_root = Planter_config['directory config']['work']+'/src/targets/alveo_u280/hardware/model_test'
...
def add_setup_fpga(fname, config):
    ...
    with open(fname, 'w') as command:
        ...
        command.write("cp " + model_test_root + "/docker-compose-sn-stack.yml ./docker-compose.yml\n")
        command.write("docker compose exec smartnic-fw sn-cli cmac enable\n")
